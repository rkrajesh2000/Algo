...
public class MedianOfSortedArrays {
	...
	public static void main(String[] args) {
      ...
      System.out.println(String.valueOf("Find Median Tow Sorted Arrays by Array Merge : " + String.valueOf(findMedianSortedArrays(nums1,nums2))));
      System.out.println(String.valueOf("Find Median Tow Sorted Arrays by Finding Kth Element : " + String.valueOf(findMedianSortedArraysWtihKthEleSearch(nums1,nums2))));
